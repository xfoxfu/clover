...
> {
  ...
  render() {
    ...
    return (
      <span>
        <Button onClick={this.handleClickOpen}>生成邀请码</Button>
        <Modal
          visible={this.state.open}
          onCancel={this.simpleClose}
          title="生成邀请码"
          footer={
            <Button key="back" onClick={this.simpleClose}>
              关闭
            </Button>
          }
        >
          ...
          <div style={{ position: "relative" }}>
            <Button type="primary" onClick={this.handleClose} loading={loading}>
              提交
            </Button>
            <Form.Item label="邀请码">
              <Input.TextArea id="code" autosize value={this.state.code} />
            </Form.Item>
